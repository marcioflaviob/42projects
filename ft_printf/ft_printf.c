...
/*   Updated: 2023/12/11 17:15:12 by mbrandao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* TODO: FIX P, YOU HAVE TO MAKE IT WORK FOR LONGS
int main()
{
    ...
    int i = printf(prompt, '$', 5242189, 17, 16, NULL, -1, us);
    //rintf(prompt, '$', 5242189, 42, 42, str);
    printf("\n\n");
    int a = ft_printf(prompt, '$', 5242189, 17, 16, NULL, -1, us);
    printf("\n\n");
